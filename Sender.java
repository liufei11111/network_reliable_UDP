...
class Sender {
	...
	private static int Max_Retransmit_Per_Packat = 20000;// The max of retransmission for a packet
	private static long Last_time_ACKed_Mills = 0;// store time in Mills when last time a ACK is received
	private static long MAX_Waiting_For_ACK = 20000;// Wait for 20 seconds only.
